...
export default function Plano10Page() {
  return (
    <motion.div
        ...
        >
          <div className="flex items-center flex-col mb-6">
            ...
            <div className="flex items-baseline">
              <h2 className="text-6xl md:text-9xl font-bold mt-2">10</h2>
              <span>mb</span>
            </div>
          </div>

          <p className="text-xl font-semibold">10 Mb de Download</p>
          <p className="text-xl font-semibold">5 Mb de Upload</p>

          <div className="flex justify-between mt-4 items-baseline">
            <p className="text-xl">R$</p>
            <h3 className="text-5xl font-bold"> 100,00</h3>
          </div>
        </motion.div>
